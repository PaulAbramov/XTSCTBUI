    ...
    public partial class NewConfig : Window
    {
        ...
        private void SaveButton_Click(object _sender, RoutedEventArgs _e)
        {
            ...
            else
            {
                ...
                if (!System.IO.File.Exists($"Files/Configs/{botInfo.Username}.json"))
                {
                    System.IO.File.WriteAllText($"Files/Configs/{botInfo.Username}.json", JsonConvert.SerializeObject(botInfo, Formatting.Indented));
                    Close();
